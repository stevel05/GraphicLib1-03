...
Public Sub Initialize
	...
	TJO.InitializeNewInstance("javafx.scene.shape.Ellipse",Null)
End Sub
...
Public Sub Create2(RadiusX As Double, RadiusY As Double)
	'If a JavaObject has been passed, you may need to create it here and remove the parameter
	TJO.InitializeNewInstance("javafx.scene.shape.Ellipse",Array As Object(RadiusX, RadiusY))
End Sub

'Creates an instance of Ellipse of the given position and size.
Public Sub Create3(CenterX As Double, CenterY As Double, RadiusX As Double, RadiusY As Double)
	'If a JavaObject has been passed, you may need to create it here and remove the parameter
	TJO.InitializeNewInstance("javafx.scene.shape.Ellipse",Array As Object(CenterX, CenterY, RadiusX, RadiusY))
End Sub
